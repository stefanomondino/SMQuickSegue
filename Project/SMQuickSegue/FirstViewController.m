...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    self.title = @"Step 1";
    [self performSegueWithIdentifier:@"next" sender:nil parameters:@{@"title":@"Step 2",@"selectedTitle":[NSString stringWithFormat:@"Index %d selected!",indexPath.row]}];
}
...
- (void)viewDidLoad {
    [super viewDidLoad];
    [self.barButton setSegueParameters:@{@"selectedTitle":@"Direct segue from button!"}];
}
